                ...
                <div className="bg-white rounded-lg p-6 shadow-lg max-w-3xl w-full h-full flex justify-center">
                   ...
                   <form onSubmit={handleSubmit} className="w-full max-w-3xl">
                        ...
                        <div className="mb-5.5">
                            ...
                            <input
                                className={`w-full rounded border ${inputErrors.name ? 'border-red-500' : 'border-stroke'} bg-gray py-3 pl-5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary`}
                                id="name"
                                name="name"
                                type="text"
                                value={name}
                        ...
                        >
                            ...
                            <textarea
                                className={`w-full rounded border ${inputErrors.description ? 'border-red-500' : 'border-stroke'} bg-gray py-3 pl-5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary`}
                                id="description"
                                name="description"
                                value={description}
                        ...
                        <div className="mb-5.5">
                            ...
                            <input
                                className={`w-full rounded border ${inputErrors.photo ? 'border-red-500' : 'border-stroke'} bg-gray py-3 pl-5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary`}
                                id="photo"
                                name="photo"
                                type="file"
                                accept="image/*"
                            ...
                            {imagePreview && (
                                <div className="mt-3">
                                    <img src={imagePreview} alt="Food Category Preview" className="w-32 h-32 object-cover rounded-lg" />
                                </div>
                            )}
                        </div>
